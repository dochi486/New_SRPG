...
public class Character : MonoBehaviour //플레이어와 몬스터에 대한 기본적인 정보를 가지고 있는 클래스
{
    ...
    protected virtual void OnDestroy()
    {
        ...
        //null을 리턴할 때 실행 안되도록 ?조건 추가해서 수정했었으나 위의 if문 추가하는 게 조금 더 나은 방법이라 또 수정!
        //어플리케이션이 꺼지고 있는 상황에서 Instance의 뒤에 있는 모든 부분이 다 실행 안되기 때문에 저 밑에 줄에
        //다른 코드가 있을 경우를 대비해서 비추천했었으나 나쁘지는 않을 수도있어서 또 다시 ? 사용
